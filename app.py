...
def build_suggestion(event):
    ...
    if home_best:
        candidates.append({
            ...
            "tipo": "h2h",
            "media": home_avg,
            "justificativa": f"O mercado precifica {home} com odd competitiva. Melhor preço encontrado em {home_book}."
        })
    ...
    if away_best:
        candidates.append({
            ...
            "tipo": "h2h",
            "media": away_avg,
            "justificativa": f"O mercado precifica {away} com odd competitiva. Melhor preço encontrado em {away_book}."
        })
    ...
    if draw_best:
        candidates.append({
            ...
            "tipo": "h2h",
            "media": None,
            "justificativa": f"Empate disponível no mercado. Melhor preço encontrado em {draw_book}."
        })
        ...
        for market in bookmaker.get("markets", []):
            ...
            for outcome in market.get("outcomes", []):
                ...
                totals_candidates.append({
                    ...
                    "tipo": "totals",
                    "media": None,
                    "justificativa": f"Mercado de gols na linha {point}. Preço próximo do alvo encontrado em {bookmaker_title}."
                })
            ...
            for _, jogo in favoritos.iterrows():
                st.markdown(
                    ...
                    <div class="card">
                        ...
                        <p><b>Mercado informativo:</b> {jogo["Sugestão"]} @ {jogo["Odd Sugerida"]}</p>
...
st.markdown("---")
st.caption("beTFM - dados via The Odds API")
